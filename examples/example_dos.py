...
plot.add_plot((1, 2))
plot.add_plot((1, 3))
plot.plot_pdos("../tests/colin/pwo.pdos_atm#2(Ge)_wfc#2(p)", 0, energy_range=[6, 15], axes_index=(1, 2), vmin=0, vmax=10)
...
plot.plot_pdos("../tests/colin/pwo.pdos_atm#1(Te)_wfc#2(p)", 0, energy_range=[6, 15], axes_index=(1, 3), vmin=0, vmax=10)
...
# We see that there is redundant information, namely there is an extra colourbar.
plot.remove_ass_plot(0, axes_index=(1, 2))  # ass_plot denotes that we are removing an assisting plot to the main axes.
